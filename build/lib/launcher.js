    ...
    _createClass(Launcher, [{
                ...
                while (1) switch (context$2$0.prev = context$2$0.next) {
                    ...
                    case 8:
                        ...
                        return _regeneratorRuntime.awrap(new _Promise(function (resolve) {
                            ...
                            _this.startInstance(_this.configParser.getSpecs(), 0);
                        }));
        ...
        value: function runSpecs() {
            ...
            while (this.getNumberOfRunningInstances() < config.maxInstances) {
                ...
                this.startInstance([schedulableCaps[0].specs.pop()], schedulableCaps[0].cid);
        ...
        key: 'startInstance',
        value: function startInstance(specs, cid) {
